...
const Photographer = () => {
  ...
  return (
	...
	c0,1.4,0,2.4,0,2.8c0,0.4-0.3,0.9-1.1,0.8C4.7,29.6,0,23.5,0,16.3C0,7.3,7.3,0,16.3,0C25.3,0,32.6,7.3,32.6,16.3z"
        ...
        <p>
          This third project is a portfolio I am currently building for a
          photographer.
        </p>
        <img
      ...
      <div className="first-block">
        <div className="first-paragraph">
          ...
          <p>
            The main work for the first phase is to integrate design files
            provided by the client into a functional portfolio in compliance
            with best practices and responsiveness. I chose to use React for its
            ease of use and the ability to add new functionalities and make them
      ...
      <div className="second-block">
        ...
        <div className="second-paragraph img-missing">
          ...
          <p>
            ...
            tool, a blog section with the possibility to write articles and
            comments, as well as the integration of a print shop.
          </p>
        </div>
      </div>

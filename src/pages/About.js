const About = () => {
  return (
    <div className="about-wrapper" id="about-link">
      <div className="about">
        <div className="about-content">
          <p>
            ...
            I’m Damien, a front-end developer from France. After graduating from
            computational biology, which made me fall in love with coding, I
            decided to pursue with web development. I combine my love for design
            and science to build intuitive and engaging user-interface web
            applications.
          </p>
          <br />
          <p>
            I’m very passionate about my work and use my free time to enhance my
            web stack. Other than coding, I find myself listening to a lot of
            music (listen my current fav below), playing video games or testing
            the best neapolitan pizzas in town.
          </p>
          <br />
          <iframe
            src="https://open.spotify.com/embed/track/5PlShq06s2kmzKQT1HBsHK"
            title="spotify-track"
            width="300"
            height="80"
            frameBorder="0"
        ...
        <div className="skills">
          <h1>Tools I like to work with</h1>
